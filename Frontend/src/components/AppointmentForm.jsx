     ...
     const [firstName,setFirstName]=useState("");
      ...
      useEffect(()=>{
        const fetchDoctors=async()=>{
            ...
            const {data}=await axios.get("https://hospital-management-system-9-j7sq.onrender.com/api/v1/user/doctors",
      ...
      const handleAppointment=async (e)=>{
        ...
        try {
          ...
          const {data}= await axios.post("https://hospital-management-system-9-j7sq.onrender.com/api/v1/appointment/post", {
            firstName, lastName, email, phone, nic, dob, gender, appointment_date:appointmentDate, department,doctor_firstName:doctorFirstName, doctor_lastName:doctorLastName,address,hasVisited:hasVisitedBool,
          },{
            withCredentials:true,
            headers:{
  ...
  return (
    <>
      ...
      <form onSubmit={handleAppointment}>
        ...
        <textarea rows="10" value={address} onchange={(e)=> setAddress(e.target.value)}
          placeholder='Address'/>
